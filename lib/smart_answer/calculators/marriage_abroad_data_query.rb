module SmartAnswer::Calculators
  class MarriageAbroadDataQuery
    ...
    SS_MARRIAGE_COUNTRIES = %w(australia bolivia chile china colombia dominican-republic estonia germany hungary kosovo mongolia montenegro nicaragua russia san-marino serbia)
